                ...
                while(isRunning){
                    ...
                    runOnUiThread(new Runnable(){
                        ...
                        public void run(){
                            ...
                            tv.setTextColor(Color.parseColor(brown));
                            ...
                            if(msg.startsWith(user_nickname)){
                                ...
                                if(msg.contains("Correct!") || msg.contains("guess!!")){
                                ...
                                if(msg.contains("server")){
                                    ...
                                    tv.setBackgroundResource(R.drawable.server);

                                }

                                else{

                                    tv.setBackgroundResource(R.drawable.chat);
